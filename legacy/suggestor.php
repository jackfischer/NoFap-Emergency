...
<form style="" id="suggestor" onsubmit="return validateForm()" method="post" action="thankyou.php">
    ...
    <button onclick="javascript:window.location='mailto:app@nofap.com'" style="margin-top:15% !important;" class="col-xs-10 col-xs-offset-1 btn btn-default">Contact app@nofap.com</button>
