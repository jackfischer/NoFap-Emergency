...
!function ($) {
    ...
    SmartBanner.prototype = {
      ...
      , show: function(callback) {
		    ...
		    //take out weird thing that's causing margin problems, copy it for religious. Jack
                    ...
                    $('#mobilereligious').addClass('sb-animation').one($.support.transition.end, transitionCallback).emulateTransitionEnd(this.options.speedIn).css('margin-top', this.origHtmlMargin+(this.bannerHeight*this.scale)); 
                    $('#religious').addClass('sb-animation').one($.support.transition.end, transitionCallback).emulateTransitionEnd(this.options.speedIn).css('margin-top', this.origHtmlMargin+(this.bannerHeight*this.scale)); 
