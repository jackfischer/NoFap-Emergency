...
$insert='INSERT INTO events (id, cat, timestamp) VALUES (NULL, "emergency", CURRENT_TIMESTAMP)';
...
$insert='INSERT INTO events (id, cat, timestamp) VALUES (NULL, "rejection", CURRENT_TIMESTAMP)';
$insertresult = mysql_query($insert) or die('Query failed: ' . mysql_error());
...
$insert='INSERT INTO events (id, cat, timestamp) VALUES (NULL, "depression", CURRENT_TIMESTAMP)';
$insertresult = mysql_query($insert) or die('Query failed: ' . mysql_error());
...
$insert='INSERT INTO events (id, cat, timestamp) VALUES (NULL, "relapsed", CURRENT_TIMESTAMP)';
$insertresult = mysql_query($insert) or die('Query failed: ' . mysql_error());
